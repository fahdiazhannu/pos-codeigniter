    ...
    <div class="col-xl-3 col-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Penghasilan Sampai Tanggal</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Rp<?= $earnings; ?></div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-header bg-primary py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-white">Total Transaksi Barang Bulanan Tahun <?= date('Y'); ?></h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    <span class="mr-2">
                        <i class="fas fa-circle text-success"></i> Incoming Goods
                    </span>
                    <span class="mr-2">
                        <i class="fas fa-circle text-danger"></i> Out-Going Goods
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-warning py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">Stok Barang Minimal</h6>
            </div>
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-success py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">Top 5 Transaksi Barang Masuk Teratas</h6>
            </div>
            <div class="table-responsive">
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            <div class="card-header bg-danger py-3">
                <h6 class="m-0 font-weight-bold text-white text-center">Top 5 Transaksi Barang Teratas</h6>
            </div>
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped table-hover text-center">
                    <thead>
